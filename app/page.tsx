...
export default function DiengRestaurant() {
  ...
  const backgroundImages = [
    "/images/restaurant-interior-busy.png",
    "/images/restaurant-dining-area.png",
    "/images/group-photo.png",
    "/images/team-gathering.png",
    "/images/friends-dining.png",
  ]
  ...
  const cateringMenuItems = [
    ...
    },
    {
      ...
      items: [
        ...
        {
          name: "Ikan Goreng",
          desc: "Nasi, Ikan goreng, telor bebek/dadar, sayur 2 macam, sambal, kerupuk, buah, teh",
          price: "30K",
        },
        {
  ...
  const restaurantMenuItems = [
    {
      category: "Menu Ala Minute / Restoran",
      items: [
        {
          name: "Mie Ayam",
          desc: "Mie ayam khas dengan bumbu pilihan",
          price: "Tersedia",
        },
        {
          name: "Mie Ayam Bakso",
          desc: "Mie ayam dengan tambahan bakso kenyal",
          price: "Tersedia",
        },
        {
          name: "Bakso",
          desc: "Porsi bakso daging sapi asli",
          price: "Tersedia",
        },
        {
          name: "Mie Ongklok",
          desc: "Mie khas Wonosobo dengan kuah kental",
          price: "Tersedia",
        },
        {
          name: "Lele Goreng",
          desc: "Lele goreng garing dengan sambal lalapan",
          price: "Tersedia",
        },
        {
          name: "Ikan Goreng",
          desc: "Ikan goreng segar pilihan",
          price: "Tersedia",
        },
        {
          name: "Opor Entok",
          desc: "Opor entok gurih dengan rempah tradisional",
          price: "Tersedia",
        },
        {
          name: "Bebek Goreng",
          desc: "Bebek goreng empuk dengan bumbu meresap",
          price: "Tersedia",
        },
        {
          name: "Ayam Goreng",
          desc: "Ayam goreng spesial Dieng Best Food",
          price: "Tersedia",
        },
      ],
    },
  ...
  return (
    <div className="min-h-screen">
      ...
      <section id="services" className="py-20 px-4 bg-background">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
                ...
                <div className="w-16 h-16 bg-primary rounded-lg flex items-center justify-center mb-6 mx-auto">
                  ...
                  >
                    <path
                      ...
                      strokeWidth={2}
                      d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-5.356-1.857M5 10H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"
                    />
                  </svg>
                </div>
            ...
            <Card className="border-2 hover:border-accent transition-all hover:shadow-xl">
              <CardContent className="p-8">
                <div className="w-16 h-16 bg-accent rounded-lg flex mb-6 text-center justify-center flex-row items-center shadow mx-auto">
                  <svg className="w-8 h-8 text-accent-foreground" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path
                      strokeLinecap="round"
                      strokeLinejoin="round"
                      strokeWidth={2}
                      d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10-11l2 2m-2-2v10a1 1 0 01-5.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"
                    />
                  </svg>
                </div>
      ...
      {/* Menu Section */}
      <section id="menu" className="py-20 px-4 bg-accent/5">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-primary mb-4 text-balance">Menu Kami</h2>
            <p className="text-xl text-muted-foreground text-pretty">
              Pilihan hidangan terbaik untuk katering dan makan di tempat
            </p>
          </div>

          {/* Restaurant Menu */}
          <div className="mb-20">
            <h3 className="text-3xl font-bold text-primary mb-8 text-center border-b-2 border-primary/20 pb-4">
              Menu Restoran (Ala Minute)
            </h3>
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {restaurantMenuItems[0].items.map((item, idx) => (
                <Card
                  key={idx}
                  className="hover:shadow-lg transition-shadow border-2 hover:border-primary/20 overflow-hidden group"
                >
          ...
          <div className="space-y-12">
            ...
            {cateringMenuItems.map((section, idx) => (
              <div key={idx}>
                <h4 className="text-2xl font-bold text-accent mb-6 text-center">{section.category}</h4>
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {section.items.map((item, itemIdx) => (
                    <Card key={itemIdx} className="hover:shadow-lg transition-shadow overflow-hidden group">
                      <CardContent className="p-6">
                        <div className="flex justify-between items-start mb-2">
                          <h4 className="text-xl font-bold text-foreground">{item.name}</h4>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative h-96 md:h-full min-h-[400px] rounded-lg overflow-hidden shadow-2xl">
              <img
                src="/images/aifaceswap-13a3ce4907cf79c0603d8621d19bdc51.jpg"
                alt="Dapur Kami"
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed">
                Menyajikan cita rasa Indonesia autentik dengan cinta dan dedikasi.
              </p>
            </div>
            <div>
